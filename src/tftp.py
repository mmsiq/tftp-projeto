        ...
        with open(filename, 'rb') as in_file:
            ...
            while True:
                ...
                if opcode == ACK:
                    ...
                    if ack_block_number not in (next_block_number, next_block_number - 1):
                        error_msg = f'Invalid block number: {ack_block_number}'
                        raise ProtocolError(error_msg)

                    if ack_block_number == next_block_number:
                    ...
                    error_msg = f'Invalid packet opcode: {opcode}. Expecting {ACK=}'
                    raise ProtocolError(error_msg)
